		...
		<div class="big-block">
			...
			<div class="report_left">
				<div class="report_row">
					<h4>Select Reporting Form</h4>
					<span class="sel-holder">
					<?php print form::dropdown('form_id', $forms, $form['form_id'], ' onchange="formSwitch(this.options[this.selectedIndex].value, 									\''.$id.'\')"') ?>
					</span>
					...
					foreach ($disp_custom_fields as $field_id => $field_property)
					{
						...
						{ // Text Field
							...
							if ($field_property['field_isdate'] == 1)
							{
								...
								' id="custom_field_'.$field_id.'" class="textarea long"');
						...
						{ // TextArea Field
							echo form::textarea('custom_field['.$field_id.']', $form['custom_field'][$field_id], ' class="textarea long" rows="3"');
						}
						echo "</div>";
					}
					?>
			...
			<div class="report_right">
				...
				<div class="row">
									<div><h5><?php echo "Is this the precise location"; ?>?</h5></div>
